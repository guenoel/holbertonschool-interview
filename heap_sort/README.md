...
Write a function that sorts an array of integers in ascending order using the [Heap sort](https://intranet.hbtn.io/rltoken/SipKuh8bwYl5hTPAGFqutw) algorithm
